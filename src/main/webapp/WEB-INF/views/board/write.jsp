...
<body>	
	<b>boardNumber:${boardNumber}</b>
	<b>groupNumber:${groupNumber}</b>
	<b>sequenceNumber:${sequenceNumber}</b>
	<b>sequenceLevel:${sequenceLevel}</b>
	<br/><br/>
	
	<form class="form_style"  action="${root}/board/writeOk.do" 
